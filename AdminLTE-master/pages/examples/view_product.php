      ...
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            ...
            <a href="overview.php"  class="btn btn-block btn-default">Go to Back </a>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
...
<div class="bs-example">
    <table class="table table-bordered">
        ...
        <tbody>
            ...
            <tr>
            <td>Image</td>
                <td>       <?php $image= $row['image1']; ?>   <?php  echo "<br>"; ?>
             <img src="image/<?php echo $image ;?>" width="300" height="300"></td>
            </tr>                      
        </tbody>
    </table>
</div>
